...
public class ImageView extends TiUIView implements OnLifecycleEvent, Handler.Callback
{
	...
	public ImageView(final TiViewProxy proxy)
	{
		super(proxy);
		...
		NappImageView view = new NappImageView(proxy.getActivity(), proxy);
	...
	private NappImageView getView()
	{
		return (NappImageView) nativeView;
	}
	...
	public void processProperties(KrollDict d)
	{
		...
		{
			view.setScaleMode( TiConvert.toString( d.get("contentMode") ) );
		}
